...
class IrrigationController extends IPSModule
{
    public function Create()
    {
        ...
        // Standardwerte nur einmalig setzen
        ...
        // Wochenplan-Event anlegen (Typ=1 zyklisch, manuell im UI konfigurieren)
    ...
    {
        parent::ApplyChanges();
        // Wochenplan-Event aktiv/inaktiv je nach Modus (2=Zeitsteuerung,3=Automatik)
    ...
    {
        // Automatikmodus (3) prüft Feuchte
